...
function toggleInfo(workExperience) {
  var infoBox = document.getElementById("info-box-" + workExperience);
  infoBox.classList.toggle("hidden");
}

function closeInfo(workExperience) {
  var infoBox = document.getElementById("info-box-" + 1);
  infoBox.classList.add("hidden");
}